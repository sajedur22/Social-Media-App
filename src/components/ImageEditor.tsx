...
const ImageEditor = ({ onClose,
    ...
    return (
        <div className="fixed w-screen h-screen left-0 top-0 bg-black bg-opacity-75 flex items-center justify-center">
            ...
            <button className="bg-white text-black py-2 px-4 font-bold rounded-full" onClick={onClose}>save</button>
                </div>
              
                <div className="w-[600px] h-[600px] flex items-center">
                    <Image src={previewURL} alt="" width={600} height={600} className={'w-full ${settings.type ===="original"?"h-full object-contain":setting.type==="square"?"aspect-square object-cover":"aspect-video object-cover" }'} />
                </div>
